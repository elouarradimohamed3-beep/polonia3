...
const copy = {
  pl: { eyebrow: "Poradniki", title: "Z bloga IPTV Polonia", sub: "Instrukcje krok po kroku i odpowiedzi na najczęstsze pytania.", all: "Wszystkie artykuły" },
  en: { eyebrow: "Guides", title: "From the IPTV Polonia blog", sub: "Step-by-step help and answers to common questions.", all: "All articles" },
} as const;
