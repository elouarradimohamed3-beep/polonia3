...
const copy = { en: { label: "Chat with us on WhatsApp", msg: "Hello! I have a question about IPTV Poland." }, pl: { label: "Napisz do nas na WhatsApp", msg: "Cześć! Mam pytanie o IPTV Poland." } } as const;
